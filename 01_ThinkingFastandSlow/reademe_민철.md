...
+ 짧은 에피스도뿐 아니라 전체 인생에 대한 직관적 평가에서 절정과 종결 법칙은 중요하지만 지속 시간은 중요하지 않다.
...
결혼사진이나 여행사진을 들춰보는 일은 드물고 심지어 전혀 안 볼 때도 종종 있지만, 사진은 기억 자아에게는 매우 유용하다.
...
2가지 인사이트를 끌어낼 수 있다.
첫째, 우리는 아주 약간의 고통 때문에 기쁜 순간들을 희석하는 경향이 있다. 가령 10분 중 9분이 행복하고 1분이 고통스러우면 9분의 행복이 준 효용은 그만큼 기억 속에 남지 않는다.
...
+ 마음이 차분히 가라앉지 않거나, 스트레스가 쌓일 때 나는 극장을 찾는다. 이걸 기억자아의 관점에서 해석해보면?
