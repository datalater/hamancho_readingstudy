...
+ 문제를 합쳐서 생각해야 할 때조차 그러지 않는 경우가 허다하다.
+ 우리는 자신이 선호하는 것에 일관성을 부여할 만한 의지나 정신적 자원을 갖고 있지 않다.
+ 인생의 감정적인 면을 개선하는 한편, 단기적 결과에 의도적으로 신경을 끄거나 줄이면 결정과 결과의 질이 모두 개선된다.

### Summary

오, 충격적이었다.
편협한 범주화를 직접 체감했다.
이 책에서 제시하는 실험들이 오랫동안 시큰둥했는데 오랜만에 깜짝 놀랐다.
